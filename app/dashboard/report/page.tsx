...
export default function ReportPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (activeTab === "ENVIRONMENTAL") {
        formData = {
          carbonEmissions: Number.parseFloat(environmentalData.carbonEmissions) || null,
          energyUsage: Number.parseFloat(environmentalData.energyUsage) || null,
          renewableEnergy: Number.parseFloat(environmentalData.renewableEnergy) || null,
          wasteRecycled: Number.parseFloat(environmentalData.wasteRecycled) || null,
        ...
        formData = {
          genderDiversity: Number.parseFloat(socialData.genderDiversity) || null,
          employeeTurnover: Number.parseFloat(socialData.employeeTurnover) || null,
          ...
          communityInvestment: Number.parseFloat(socialData.communityInvestment) || null,
          employeeSatisfaction: Number.parseFloat(socialData.employeeSatisfaction) || null,
        }
      } else {
        formData = {
          boardDiversity: Number.parseFloat(governanceData.boardDiversity) || null,
          ethicsViolations: Number.parseInt(governanceData.ethicsViolations) || null,
          policyCoverage: Number.parseFloat(governanceData.policyCoverage) || null,
          dataBreaches: Number.parseInt(governanceData.dataBreaches) || null,
          complianceScore: Number.parseFloat(governanceData.complianceScore) || null,
  ...
  const handleAdminAction = async (id: string, action: "APPROVED" | "REJECTED", reason?: string) => {
    if (!isAdmin) return
  ...
  const handleGovernanceChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    const { id, value } = e.target
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
              ...
              <h1 className="text-3xl font-bold tracking-tight">ESG Data Reporting</h1>
              <p className="text-muted-foreground">Enter your Environmental, Social, and Governance metrics</p>
            </div>
          ...
          {showSuccessAlert && (
            <Alert className="mb-6 bg-green-50 border-green-200">
              ...
              <AlertDescription>
                Your ESG data has been submitted and is pending review by our ESG team. You'll be notified once it's
                approved.
              </AlertDescription>
            </Alert>
          )}

          {submissions.length > 0 && submissions[0].status === "REJECTED" && submissions[0].rejectionReason && (
            <Alert className="mb-6 bg-red-50 border-red-200">
              <AlertTriangle className="h-4 w-4 text-red-600" />
              <AlertTitle>Revision Required</AlertTitle>
              <AlertDescription>{submissions[0].rejectionReason}</AlertDescription>
            </Alert>
          )}
          ...
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>Previous data submissions and their status</CardDescription>
            </CardHeader>
            <CardContent>
              {isLoading ? (
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              {submission.status === "PENDING"
                                ? "Awaiting review"
                                : `${submission.status === "APPROVED" ? "Approved" : "Reviewed"} by ${submission.reviewer?.name} on ${new Date(submission.reviewedAt!).toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })}`}
                            </p>
                          </div>
                        </div>
                        <div className="flex items-center gap-2">
                          ...
                          {submission.status === "PENDING" && isAdmin && (
                            <div className="flex gap-2">
                              <Button
                                ...
                                onClick={() => handleAdminAction(submission.id, "APPROVED")}
                                disabled={isLoading}
                              >
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  ...
                                  if (reason) {
                                    handleAdminAction(submission.id, "REJECTED", reason)
                                  }
                                }}
                                disabled={isLoading}
                              >
                          ...
                          {submission.status === "PENDING" && !isAdmin && (
                            <div className="flex items-center text-muted-foreground text-xs">
                              <Lock className="h-3 w-3 mr-1" /> Awaiting ESG team review
                            </div>
                          )}
                        </div>
                      </div>
          ...
          <Tabs defaultValue="ENVIRONMENTAL" className="mb-8" onValueChange={setActiveTab}>
            ...
            <TabsContent value="ENVIRONMENTAL" className="space-y-6">
              <Card>
                <CardHeader className="bg-[#e2f2df] bg-opacity-50">
                  ...
                  <CardDescription>Report your company's impact on the natural world</CardDescription>
                </CardHeader>
                <CardContent className="pt-6">
                  <form id="esg-form" onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid gap-6 md:grid-cols-2">
                      <div className="space-y-4">
                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            <Label htmlFor="environmental-carbonEmissions">Carbon Emissions</Label>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            />
                            <span className="text-sm text-muted-foreground whitespace-nowrap">tons CO2e</span>
                          </div>
                        </div>

                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            <Label htmlFor="environmental-energyUsage">Energy Usage</Label>
                        ...
                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            <Label htmlFor="environmental-renewableEnergy">Renewable Energy</Label>
                      ...
                      <div className="space-y-4">
                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            <Label htmlFor="environmental-wasteRecycled">Waste Recycled</Label>
                        ...
                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            <Label htmlFor="environmental-waterUsage">Water Usage</Label>
                          ...
                          <div className="flex items-center gap-2">
                            <Input
                              ...
                              onChange={handleEnvironmentalChange}
                            />
                            <span className="text-sm text-muted-foreground whitespace-nowrap">gallons</span>
                          </div>
                        </div>

                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            <Label htmlFor="environmental-paperUsage">Paper Usage</Label>
                          ...
                          <div className="flex items-center gap-2">
                            <Input
                              ...
                              onChange={handleEnvironmentalChange}
                            />
                            <span className="text-sm text-muted-foreground whitespace-nowrap">reams</span>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <CardFooter className="bg-muted/20 border-t flex justify-between">
                  <div className="flex items-center text-sm text-muted-foreground">
                    ...
                    Data will be reviewed by our ESG team before being published to your dashboard
                  </div>
                  <Button
                    type="submit"
                    form="esg-form"
                  ...
                  >
                    <Save className="mr-2 h-4 w-4" />
                    {isSubmitting ? "Submitting..." : "Submit Environmental Data"}
                  </Button>
                </CardFooter>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="SOCIAL" className="space-y-6">
              <Card>
                <CardHeader className="bg-[rgba(128,0,128,0.1)]">
                  ...
                  <CardDescription>Report your impact on people and communities</CardDescription>
                </CardHeader>
                <CardContent className="pt-6">
                  <form id="esg-form" onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid gap-6 md:grid-cols-2">
                      <div className="space-y-4">
                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            <Label htmlFor="social-genderDiversity">Gender Diversity</Label>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            />
                            <span className="text-sm text-muted-foreground whitespace-nowrap">% women</span>
                          </div>
                        </div>

                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            <Label htmlFor="social-employeeTurnover">Employee Turnover</Label>
                        ...
                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            <Label htmlFor="social-trainingHours">Training Hours</Label>
                          ...
                          <div className="flex items-center gap-2">
                            <Input
                              ...
                              onChange={handleSocialChange}
                            />
                            <span className="text-sm text-muted-foreground whitespace-nowrap">hrs/employee</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-4">
                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            <Label htmlFor="social-payEquityRatio">Pay Equity Ratio</Label>
                          ...
                          <div className="flex items-center gap-2">
                            <Input
                              ...
                              onChange={handleSocialChange}
                            />
                            <span className="text-sm text-muted-foreground whitespace-nowrap">women:men</span>
                          </div>
                        </div>

                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            <Label htmlFor="social-communityInvestment">Community Investment</Label>
                          ...
                          <div className="flex items-center gap-2">
                            <Input
                              ...
                              onChange={handleSocialChange}
                            />
                            <span className="text-sm text-muted-foreground whitespace-nowrap">% of profit</span>
                          </div>
                        </div>

                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            <Label htmlFor="social-employeeSatisfaction">Employee Satisfaction</Label>
            ...
            <TabsContent value="GOVERNANCE" className="space-y-6">
              <Card>
                <CardHeader className="bg-[rgba(255,140,0,0.1)]">
                  ...
                  <CardDescription>Report your business ethics and leadership practices</CardDescription>
                </CardHeader>
                <CardContent className="pt-6">
                  <form id="esg-form" onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid gap-6 md:grid-cols-2">
                      <div className="space-y-4">
                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            <Label htmlFor="governance-boardDiversity">Board Diversity</Label>
                        ...
                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            <Label htmlFor="governance-ethicsViolations">Ethics Violations</Label>
                          ...
                          <div className="flex items-center gap-2">
                            <Input
                              ...
                              onChange={handleGovernanceChange}
                            />
                            <span className="text-sm text-muted-foreground whitespace-nowrap">incidents</span>
                          </div>
                        </div>

                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            <Label htmlFor="governance-policyCoverage">Policy Coverage</Label>
                      ...
                      <div className="space-y-4">
                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            <Label htmlFor="governance-dataBreaches">Data Breaches</Label>
                        ...
                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            <Label htmlFor="governance-complianceScore">Compliance Score</Label>
                        ...
                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            <Label htmlFor="governance-riskAssessment">Risk Assessment Frequency</Label>
